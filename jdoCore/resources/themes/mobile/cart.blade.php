...
@section('content')
 ...
 <div class="cart-item d-flex flex-column p-4 {{ !$loop->last ? 'border-bottom' : '' }}" id="item-{{ $item->id }}">
 <!-- Image -->
 <div class="me-sm-4 mb-3 " style="width:100px; height:100px; flex-shrink: 0;">
 ...
 <!-- Info -->
 <div class="flex-grow-1 pe-sm-3 mb-3 " style="min-width: 0;">
 ...
 <!-- Actions -->
 <div class="d-flex align-items-center justify-content-between gap-3 flex-shrink-0" style="min-width: 140px;">
