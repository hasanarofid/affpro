...
@section('content')
    <div class="d-flex align-items-center mb-4">
        <h5 class="mb-0 fw-bold me-auto">Artikel Blog</h5>
        <a href="{{ route('admin.blog.create') }}" class="btn btn-sm btn-primary" style="border-radius:8px">
    ...
    <div class="card table-card border-0 shadow-sm">
        ...
        <div class="card-body p-0">
            <div class="table-responsive p-3">
                <table class="table table-hover mb-0 align-middle w-100" id="blogTable">
        ...
        $(document).ready(function () {
            $('#blogTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'views_count', name: 'views' },
                    { data: 'status_badge', name: 'is_published', orderable: false, searchable: false },
