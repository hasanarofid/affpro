...
@section('content')
 ...
 <button class="btn w-100 fw-bold rounded-4 shadow-sm py-3 d-flex align-items-center justify-content-center gap-2" 
 style="background-color: var(--bs-primary); border: none; color: white;" 
 type="button" data-bs-toggle="collapse" data-bs-target="#mobileAccountMenu" aria-expanded="false" aria-controls="mobileAccountMenu">
 <i class="bi bi-person-lines-fill fs-5"></i> <span style="font-size: 0.95rem;">Menu Navigasi Akun</span>
 </button>
 </div>

 <!-- Sidebar Navigation -->
 <div class="col-12 collapse" id="mobileAccountMenu">
 <div class="account-sidebar-card" style="z-index: 10;">
 <!-- Header -->
