            ...
            <div class="col-lg-7">
                <div class="product-info-card card bg-white">
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <h1 class="fw-bold text-dark mb-4" style="font-size: clamp(1.4rem, 6vw, 2.2rem); line-height: 1.3; letter-spacing: -0.02em;">{{ $product->name }}</h1>
                        ...
                        <div class="pt-4 border-top mt-2">
                            @if(!auth()->check() || !auth()->user()->hasAnyRole(['admin', 'superadmin']))
                                ...
                                <form action="{{ route('chat.store') }}" method="POST" class="mt-2 w-100 d-none d-md-block" id="webChatForm">
                                    @csrf
